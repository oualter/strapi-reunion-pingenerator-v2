...
export interface PluginPingeneratorPingeneratorSetting
  extends Schema.SingleType {
  collectionName: 'pingenerator_settings';
  info: {
  ...
  attributes: {
    imageToPinOnUrl: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'plugin::pingenerator.pingenerator-setting': PluginPingeneratorPingeneratorSetting;
